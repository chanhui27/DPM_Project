...
public class ManageUpdateModuleAdapter extends RecyclerView.Adapter<ManageUpdateModuleAdapter.ModuleHolder> {
    ...
    class ModuleHolder extends RecyclerView.ViewHolder {
        ...
        public ModuleHolder(View itemView) {
            super(itemView);
            textViewCode = itemView.findViewById(R.id.manager_update_text_view_module_code);
            textViewTitle = itemView.findViewById(R.id.manager_update_text_view_module_title);
            relativeLayout = itemView.findViewById(R.id.manager_update_cardview_relative_layout);
